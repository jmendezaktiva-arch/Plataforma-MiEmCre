...
export const login = async (email, password) => {
    try {
        // TRACEABILIDAD: Iniciamos sesión. El Centinela en app.js detectará el cambio
        // y gestionará la redirección o el cambio de contraseña obligatorio.
        await signInWithEmailAndPassword(auth, email, password);
        console.log("🔑 Autenticación exitosa. Delegando control al Centinela de app.js");
    } catch (error) {
